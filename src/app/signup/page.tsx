      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0f1f1a] p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-lg mb-8">
            No credit card required. Launch in minutes and start handling dealership calls 24/7.
          </p>

          <div className="space-y-4">
            {[
              '50 free calls every month',
              'Human-sounding AI receptionist calls',
              'Capture sales and service leads automatically',
        ...
        <div className="w-full max-w-md">
          ...
          <form className="space-y-5" onSubmit={handleSignup}>
            ...
            <div>
              ...
              <p className="mt-1.5 text-sm text-[#0f1f1a]/50">This helps us customize sales and service call routing</p>
            </div>

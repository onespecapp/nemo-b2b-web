    ...
    return (
      <div className="space-y-6">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-[#0f1f1a]/50">Leads</p>
            <h1 className="font-display text-3xl sm:text-4xl">Leads &amp; Contacts</h1>
            <p className="mt-1 text-sm text-[#0f1f1a]/60">Loading leads...</p>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-[#0f1f1a]/60">
            {showingCount} lead{showingCount !== 1 ? 's' : ''} in your pipeline.
            {normalizedSearch && (
      ...
      {showForm && (
        <div className="rounded-3xl border border-[#0f1f1a]/10 bg-white/90 p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <h2 className="font-display text-2xl">New lead</h2>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-2xl border border-[#0f1f1a]/20 bg-white px-4 py-3 text-sm focus:border-[#f97316] focus:outline-none"
                  placeholder="Interested in SUV lease options"
                />
              </div>
              <div>
      ...
      {customers.length > 0 ? (
        <>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="flex-1 rounded-full border border-[#0f1f1a]/10 bg-white px-4 py-2 text-sm shadow-sm">
              <label htmlFor="customer-search" className="sr-only">Search leads</label>
              <input
                id="customer-search"
                type="search"
                value={searchTerm}
        ...
        <div className="rounded-3xl border border-dashed border-[#0f1f1a]/20 bg-white/80 p-10 text-center">
          <h3 className="font-display text-2xl">No leads yet</h3>
          <p className="mt-2 text-sm text-[#0f1f1a]/60">Add your first lead to start tracking calls and follow-ups.</p>
          <button
      ...
      <AccessibleModal
        ...
        ariaLabel={`Edit lead: ${editingCustomer?.name || ''}`}
        ...
        {editingCustomer && (
          <>
            <div className="flex items-center justify-between border-b border-[#0f1f1a]/10 px-6 py-4">
              <div>
                <p className="text-xs uppercase tracking-[0.3em] text-[#0f1f1a]/50">Edit lead</p>
                ...
                <div className="space-y-6">
                  <div className="rounded-3xl border border-[#0f1f1a]/10 bg-[#f8f5ef] p-5">
                    ...
                    {detailsLoading ? (
                      ...
                      <div className="mt-6 rounded-2xl border border-dashed border-[#0f1f1a]/20 bg-white/70 px-5 py-6 text-sm text-[#0f1f1a]/60">
                        No appointments yet for this lead.
                      </div>
                    ) : (
